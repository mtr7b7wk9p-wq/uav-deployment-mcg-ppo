...
ABLATION_REGISTRY: Dict[str, AblationSpec] = {
    ...
    "ppo_resource_cognition": AblationSpec(
        method_name="ppo_resource_cognition",
        config_name="ppo_resource_cognition",
        method_label="PPO-Resource-Cognition",
        paper_name="PPO-Resource-Cognition",
        display_name="PPO-Resource-Cognition",
        description="Flat-MLP PPO baseline for resource cognition and spectrum-demand scheduling.",
        category="main",
        trainer_family="ppo_shared",
        policy_family="resource_cognition_flat_mlp",
        scenario_overrides={
            "method_name": "ppo_resource_cognition",
            "rl_method_family": "ppo_shared",
            "policy_architecture": "resource_cognition_flat_mlp",
    ...
    "mcg_ppo_resource_cognition": AblationSpec(
        ...
        description="Resource-cognition MCG-PPO with structured aggregation, scheduling, and per-UAV difference rewards.",
        category="main",
        trainer_family="ppo_shared",
        policy_family="resource_cognition_mcg_encoder",
        scenario_overrides={
            "method_name": "mcg_ppo_resource_cognition",
            "rl_method_family": "ppo_shared",
            "policy_architecture": "resource_cognition_mcg_encoder",
            "use_resource_cognition": True,
            "cognition_use_per_agent_rewards": True,
        },
        ppo_overrides={
            "use_resource_cognition_encoder": True,
        },
    ),
    "ippo": AblationSpec(
        method_name="ippo",
