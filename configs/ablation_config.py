...
ABLATION_REGISTRY: Dict[str, AblationSpec] = {
    ...
    "ppo_resource_cognition": AblationSpec(
        ...
        description="Flat-MLP PPO baseline for the explicit resource-cognition environment.",
        category="main",
        trainer_family="ppo_shared",
    ...
    "mcg_ppo_resource_cognition": AblationSpec(
        ...
        description="Resource-cognition MCG-PPO with task-set and received-message aggregation.",
        category="main",
        trainer_family="ppo_shared",
